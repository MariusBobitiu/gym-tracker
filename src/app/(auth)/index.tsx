  ...
  return (
    <Screen
      ...
      <View className="flex-1 items-center justify-center">
        ...
        <P className="px-4 text-center" style={{ fontSize: 24, color: colors.mutedForeground }}>
      ...
      <View className="mt-3 w-full flex-row items-center justify-center px-16">
        <View className="h-px w-1/2" style={{ backgroundColor: colors.foreground, opacity: 0.2 }} />
        <P
